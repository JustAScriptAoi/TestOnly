...
local Themes = {
    ...
    Purple = {
        ...
        Active = Color3.fromRGB(85, 120, 240),
        ActiveTab = Color3.fromRGB(75, 105, 225),
        ClickFlash = Color3.fromRGB(65, 95, 210),
        BorderBase = Color3.fromRGB(150, 90, 255),
        Muted = Color3.fromRGB(70, 50, 120),
        UseImage = false,
        BgColor = Color3.fromRGB(48, 26, 92),
        BubbleColors = {Color3.fromRGB(150, 90, 255), Color3.fromRGB(100, 150, 255)},
        GradientColors = {
            Color3.fromRGB(150, 60, 255),
            Color3.fromRGB(35, 15, 75),
            Color3.fromRGB(90, 130, 255),
            Color3.fromRGB(25, 15, 60),
            Color3.fromRGB(150, 60, 255)
        },
    ...
    VelocityX = {
        Accent = Color3.fromRGB(60, 220, 230),
        Active = Color3.fromRGB(40, 190, 200),
        ActiveTab = Color3.fromRGB(35, 170, 185),
        ClickFlash = Color3.fromRGB(30, 150, 165),
        BorderBase = Color3.fromRGB(50, 200, 210),
        Muted = Color3.fromRGB(25, 100, 105),
        UseImage = false,
        BgColor = Color3.fromRGB(10, 35, 40),
        BubbleColors = {Color3.fromRGB(60, 180, 255), Color3.fromRGB(80, 255, 200)},
        GradientColors = {
            Color3.fromRGB(60, 150, 255),
            Color3.fromRGB(50, 200, 220),
            Color3.fromRGB(80, 255, 190),
            Color3.fromRGB(50, 200, 220),
            Color3.fromRGB(60, 150, 255)
        },
        PanelBg = Color3.fromRGB(14, 32, 36),
        PanelAlt = Color3.fromRGB(18, 40, 44),
        TabInactive = Color3.fromRGB(22, 48, 52),
        SwitchOff = Color3.fromRGB(35, 60, 64),
        InputBg = Color3.fromRGB(10, 22, 25),
        TitleBtnBg = Color3.fromRGB(20, 60, 68),
        MainBg = Color3.fromRGB(8, 18, 20),
        WidgetBg = Color3.fromRGB(10, 24, 26)
    }
}
