...
function Library:Init(titleName, themeName)
    ...
    function Window:CreateTab(tabName)
        ...
        function Elements:AddToggle(text, defaultState, callback)
            ...
            SwitchBg.BackgroundColor3 = toggled and CurrentTheme.Active or Color3.fromRGB(40, 55, 48)
            SwitchBg.ZIndex = 4
            ...
            ToggleClick.MouseButton1Click:Connect(function()
                toggled = not toggled
                TweenService:Create(SwitchBg, TweenInfo.new(0.2), {BackgroundColor3 = toggled and CurrentTheme.Active or Color3.fromRGB(40, 55, 48)}):Play()
        ...
        function Elements:AddMultiDropdown(text, options, callback)
            ...
            for _, optionText in ipairs(options) do
                ...
                OptionBtn.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(CheckBox, TweenInfo.new(0.2), {BackgroundColor3 = checked and CurrentTheme.Active or Color3.fromRGB(40, 55, 48)}):Play()
                    UpdateLabel()
        ...
        function Elements:AddParagraph(title, content)
            ...
            ParaFrame.BackgroundColor3 = Color3.fromRGB(15, 28, 22)
        ...
        function Elements:AddStatus(text, defaultText)
            ...
            StatusFrame.BackgroundColor3 = Color3.fromRGB(15, 28, 22)
